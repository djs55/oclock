(* OASIS_START *)
(* DO NOT EDIT (digest: 5baf1fbe5edbc4378c291c04b6ce287e) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("oclock", [])];
     lib_c = [("oclock", ".", [])];
     flags =
       [
          (["oasis_library_oclock_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lrt"])]);
          (["oasis_library_oclock_cclib"; "ocamlmklib"; "c"],
