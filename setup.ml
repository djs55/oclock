...
(* OASIS_START *)
(* DO NOT EDIT (digest: d669b58f01e53cb442d25bdfb644b024) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Micka\195\171l Delahaye <mickael.delahaye@gmail.com>"];
          homepage = None;
          synopsis = "Precise POSIX clock for OCaml";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\234\248\012~\138\005\018\176\212\2242\179P\252\181\194";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
